...
void txt_to_lines(const std::string& line, int num_per_line,
...
int main1(int argc, char* argv[])
{
    ...
    const char* font_help =
        "path of font file like /usr/share/fonts/opentype/noto/NotoSansCJK-Regular.ttc";
#elif BOOST_OS_MACOS
    ...
    desc.add_options()("help,h", "produce help message")(
        ...
        "ttf", boost::program_options::value<decltype(ttf)>(&ttf), font_help)(
